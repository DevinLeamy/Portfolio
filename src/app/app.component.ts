...
export class AppComponent implements OnInit, OnDestroy {
        ...
        getColor(page: number) {
                ...
                if (page == 0 && this.pageService.onProjectsPage()) return 'rgb(1, 108, 170)'
                else if (page == 1 && this.pageService.onHomePage()) return 'rgb(1, 108, 170)'
                else if (page == 2 && this.pageService.onAboutPage()) return 'rgb(1, 108, 170)'
                else return 'rgb(32, 32, 32)'
        }
